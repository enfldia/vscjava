...
public class BankApp {
    ...
    public static void main(String[] args) {
        ...
        while (run) {
            ...
            if (Integer.parseInt(selectNo) == 1) {
                createAccount();
            } else if (Integer.parseInt(selectNo) == 2) {
                accountList();
            } else if (Integer.parseInt(selectNo) == 3) {
                deposit();
            } else if (Integer.parseInt(selectNo) == 4) {
                withdraw();
            } else if (Integer.parseInt(selectNo) == 5) {
                run = false;
            }
        }
